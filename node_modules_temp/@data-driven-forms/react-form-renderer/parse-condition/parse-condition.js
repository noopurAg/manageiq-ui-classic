...
exports.parseCondition = exports["default"] = void 0;
...
var parseCondition = function parseCondition(condition, values, field) {
  ...
  if (typeof finalWhen === 'string') {
    return fieldCondition((0, _get["default"])(values, finalWhen), condition) ? positiveResult : negativeResult;
  }

  if (Array.isArray(finalWhen)) {
    return finalWhen.map(function (fieldName) {
      return fieldCondition((0, _get["default"])(values, typeof fieldName === 'function' ? fieldName(field) : fieldName), condition);
