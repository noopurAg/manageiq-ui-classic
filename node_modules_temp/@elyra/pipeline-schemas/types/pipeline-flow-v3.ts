...
export type NodeTypeDef = ExecutionNodeDef | SupernodeDef | BindingEntryNodeDef | BindingExitNodeDef | ModelNodeDef;
/**
...
/**
 * X/Y pan and scale amounts for the canvas.
 */
export type ZoomObjectDef =
  | number
  | {
      /**
...
export interface ExecutionNodeDef {
  ...
  /**
   * @deprecated
   * Deprecated - use description in pipeline-flow-ui-v3-schema.json#/definitions/node_ui_def instead.
   */
  description?: string;
  /**
...
export interface NodeLinkDef {
   ...
   */
  app_data?: {
    ui_data?: NodeLinkUiDef;
    [k: string]: unknown;
  };
}
/**
 * Node link UI properties.
 */
export interface NodeLinkUiDef {
  /**
 ...
 */
export interface DecorationSharedProperties {
  /**
...
export interface NodeUiDef {
   ...
   * @minItems 0
   */
  associations?: AssociationLinkDef[];
  /**
 ...
 */
export interface AssociationLinkDef {
  /**
...
/**
 * Pipeline UI properties
 */
export interface PipelineUiDef {
  /**
   * User-defined description
   */
  description?: string;
...
export interface CommentDef {
  ...
  content?: string;
  /**
   * The type of content either regular or markdown or WYSIWYG
   */
  content_type?: string;
  /**
...
/**
 * Pipeline flow UI properties.
 */
export interface PipelineFlowUiDef {
  /**
   * User-defined name
   */
  name?: string;
