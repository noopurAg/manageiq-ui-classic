...
import { iconAdd, iconAddSolid, iconAddOutline } from '@carbon/icons-react';
import { withKnobs, select, text } from '@storybook/addon-knobs';
import Icon from '../Icon';
import IconSkeleton from '../Icon/Icon.Skeleton';
var icons = {
  'Add (iconAdd from `@carbon/icons-react`)': 'iconAdd',
  'Add with filled circle (iconAddSolid from `@carbon/icons-react`)': 'iconAddSolid',
  'Add with circle (iconAddOutline from `@carbon/icons-react`)': 'iconAddOutline'
};
var iconMap = {
  iconAdd: iconAdd,
