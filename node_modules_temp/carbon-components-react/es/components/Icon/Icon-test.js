...
import { iconSearch } from '@carbon/icons-react';
...
describe('Icon', function () {
  describe('Renders as expected', function () {
    ...
    it('should receive width props', function () {
      expect(wrapper.props().width).toEqual('20');
    });
    it('should receive height props', function () {
      expect(wrapper.props().height).toEqual('20');
    });
    it('should receive style props', function () {
